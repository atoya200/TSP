...
def mostrar_rutas_secuencialmente(i):
    if i < len(coordenadas_tour) - 1:
        ...
        root_tk.after(1000, mostrar_rutas_secuencialmente, i + 1)  # Esperar 1 segundo antes de mostrar la siguiente ruta

# Iniciar la visualización secuencial
root_tk.after(1000, mostrar_rutas_secuencialmente, 0)
print("costo optimo", min_cost,"aca es el camino", tour)
